...
function loadComponent(component: string, type: DynamicComponentType) {
  switch (type) {
...
function DynamicComponent({ component, type, props }: { component: string; type: DynamicComponentType; props?: any }) {
